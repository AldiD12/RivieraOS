...
namespace BlackBear.Services.Core.Migrations
{
    ...
    [Migration("20260404180427_AddBusinessRegistrationFields")]
    partial class AddBusinessRegistrationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlackBear.Services.Core.Entities.BusinessFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("HasBookings")
                        .HasColumnType("bit")
                        .HasColumnName("has_bookings");

                    b.Property<bool>("HasDigitalMenu")
                        .HasColumnType("bit")
                        .HasColumnName("has_digital_menu");

                    b.Property<bool>("HasEvents")
                        .HasColumnType("bit")
                        .HasColumnName("has_events");

                    b.Property<bool>("HasPulse")
                        .HasColumnType("bit")
                        .HasColumnName("has_pulse");

                    b.Property<bool>("HasTableOrdering")
                        .HasColumnType("bit")
                        .HasColumnName("has_table_ordering");
                    ...
                    b.ToTable("core_business_features");
                });
            ...
            modelBuilder.Entity("BlackBear.Services.Core.Entities.BusinessFeature", b =>
                {
                    b.HasOne("BlackBear.Services.Core.Entities.Business", "Business")
                        .WithOne("Feature")
                        .HasForeignKey("BlackBear.Services.Core.Entities.BusinessFeature", "BusinessId")
